...
const Header = () => {
  ...
  return (
    <header>
      <nav className="flex items-center justify-between border-b border-solid border-b-border p-4">
        <div className="flex items-center gap-2">
          <MenuBtn openMenu={openMenu} handleMenu={handleMenu} />
        ...
        <ul className="hidden items-center gap-3 font-semibold text-hashforeground lg:flex ">
          <li>My Feed</li>
          <li>Bookmarks</li>
        </ul>
        <div className="flex items-center gap-1 md:gap-3">
          <button className="hidden h-12 w-12 items-center justify-center rounded-full border border-solid border-transparent bg-transparent p-0 text-hashforeground duration-300 hover:border-border hover:bg-transparent md:flex">
            <Search className="stroke-hashforeground" />
          </button>
          <div>
            <Button className="hidden items-center gap-2 rounded-full bg-hashaccent py-[0.625rem] pl-4 pr-[1.125rem] text-[0.875rem] text-white transition-colors duration-300 hover:bg-hashaccent/80 md:flex">
              <span>
          ...
          <div>
            <Button className="hidden h-12 w-12 rounded-full border border-solid border-transparent bg-transparent p-0 text-hashforeground duration-300 hover:border-border hover:bg-transparent md:block">
              <Bell className=" stroke-hashforeground" />
            </Button>
          </div>
          <Button className="h-12 w-12 items-center justify-center rounded-full border border-solid border-transparent bg-transparent p-0 text-hashforeground duration-300 hover:border-border hover:bg-transparent md:hidden">
            <span>
              <Pencil className="h-4 w-4" />
            </span>
          </Button>
